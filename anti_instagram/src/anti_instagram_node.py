...
from duckietown_msgs.msg import AntiInstagramTransform  # @UnresolvedImport
...
class AntiInstagramNode():
    def __init__(self):
        ...
        self.sub_image = rospy.Subscriber("camera_node/image/compressed_no_filter", CompressedImage, self.cbNewImage,queue_size=1)
